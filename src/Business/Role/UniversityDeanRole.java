...
import userinterface.DeanRole.OfficerWorkAreaJPanel;
...
public class UniversityDeanRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new OfficerWorkAreaJPanel(userProcessContainer, userAccount, (DeanOrganization)organization, enterprise);
    }
