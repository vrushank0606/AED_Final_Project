...
public class RequestCaseStudyJPanel extends javax.swing.JPanel {
    ...
    public RequestCaseStudyJPanel(JPanel jpanel, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    private void requestGovSecretaryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestGovSecretaryBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            SelectCourseJPanel treasurerProcessWorkRequestJPanel = new SelectCourseJPanel(jPanel, request);
