...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        networkJTable.setFont(new java.awt.Font("Skia", 0, 14)); // NOI18N
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 210, 515, 91));

        jLabel1.setFont(new java.awt.Font("Skia", 1, 14)); // NOI18N
        jLabel1.setText("Name:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 120, -1, -1));
        ...
        add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 170, -1, -1));

        nameJTextField.setFont(new java.awt.Font("Skia", 0, 14)); // NOI18N
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 110, 93, -1));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 30, -1, -1));

        btnDelete.setBackground(new java.awt.Color(2, 79, 133));
        btnDelete.setFont(new java.awt.Font("Skia", 1, 14)); // NOI18N
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 160, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/73Q8.gif"))); // NOI18N
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 500, 360));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (networkNames.contains(name)) {
            ...
            if (name == null || name.equals("")) {
                JOptionPane.showMessageDialog(null, "Field cannot be blank", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            } else {
