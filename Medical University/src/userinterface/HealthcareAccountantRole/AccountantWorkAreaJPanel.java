...
public class AccountantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/receptionist-silhouette-20 (1).png"))); // NOI18N
        jLabel1.setText("Patient Details");

        btnCreateAppointment.setBackground(new java.awt.Color(2, 79, 133));
        btnCreateAppointment.setFont(new java.awt.Font("Skia", 1, 12)); // NOI18N
        ...
        btnProcessMedicalBillings.setBackground(new java.awt.Color(2, 79, 133));
        btnProcessMedicalBillings.setFont(new java.awt.Font("Skia", 1, 12)); // NOI18N
        ...
        tblAllPatients.setBackground(new java.awt.Color(2, 79, 133));
        ...
        btnReport.setBackground(new java.awt.Color(2, 79, 133));
        btnReport.setFont(new java.awt.Font("Skia", 1, 12)); // NOI18N
