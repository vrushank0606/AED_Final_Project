...
import userinterface.ProfessorRole.ProfessorWorkAreaJPanel;
...
public class ProfessorRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new ProfessorWorkAreaJPanel(userProcessContainer, userAccount, enterprise, (ProfessorOrganization)organization, business);
    }
